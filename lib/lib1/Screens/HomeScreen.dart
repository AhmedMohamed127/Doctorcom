  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading:IconButton(icon: Icon(Icons.note,
          color: Colors.white,), onPressed: () =>   Navigator.pushNamed(context,'Abo OMo')) ,
      ),
      body: isLoading
          ? Center(
              child: Container(
          ...
          : Column(
              children: [
                ...
                MyButton(color: Colors.amber, title: 'Search', onPressed: onSearch),
                SizedBox(
