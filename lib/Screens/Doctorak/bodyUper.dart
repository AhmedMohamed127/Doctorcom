...
class UperBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return UperBodySreen();
  }
}

class UperBodySreen extends StatefulWidget {
  @override
  _UperBodySreenState createState() => _UperBodySreenState();
}

class _UperBodySreenState extends State<UperBodySreen> {
  double _height;
  double _width;
  double _pixelRatio;
  bool _large;
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    Stack(
                      children: [
                         Image.asset("assets/images/body3.jpg",
                            fit: BoxFit.fill),
                        Opacity(
                          opacity: 0.2,
                          child: Container(
