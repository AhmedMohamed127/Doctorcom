...
class HumanHead extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return HumanHeadSreen();
  }
}

class HumanHeadSreen extends StatefulWidget {
  @override
  _HumanHeadSreenState createState() => _HumanHeadSreenState();
}

class _HumanHeadSreenState extends State<HumanHeadSreen> {
  double _height;
  double _width;
  double _pixelRatio;
  bool _large;
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    Stack(
                      children: [
                        Image.asset("assets/images/body2.png",
                            fit: BoxFit.fill),
                        Opacity(
                          opacity: 0.2,
                          child: Container(
